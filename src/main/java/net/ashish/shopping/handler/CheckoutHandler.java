package net.ashish.shopping.handler;
...
import net.ashish.shopping.model.CheckoutModel;
import net.ashish.shopping.model.UserModel;
import net.ashish.shoppingbackend.dao.CartLineDAO;
import net.ashish.shoppingbackend.dao.ProductDAO;
import net.ashish.shoppingbackend.dao.UserDAO;
import net.ashish.shoppingbackend.dto.Address;
import net.ashish.shoppingbackend.dto.Cart;
import net.ashish.shoppingbackend.dto.CartLine;
import net.ashish.shoppingbackend.dto.OrderDetail;
import net.ashish.shoppingbackend.dto.OrderItem;
import net.ashish.shoppingbackend.dto.Product;
import net.ashish.shoppingbackend.dto.User;
...
public class CheckoutHandler {
	...
	public String saveOrder(CheckoutModel checkoutModel) {
		...
		for(CartLine cartLine : cartLines) {
			...
			logger.info("Inside Checkout index method- INFO");
