					...
					<div id="carousel-example-generic" class="carousel slide"
						...
						<div class="carousel-inner">
							...
							<div class="item active">
								<img class="slide-image" src="${images}/banner1.jpg" alt="Dell Inspiron">
							</div>
							<div class="item">
								<img class="slide-image" src="${images}/banner2.jpg" alt="Samsung Galaxy s7">
							</div>
							<div class="item">
                ...
                <div class="row is-table-row">
                    ...
                    <div class="col-sm-4" ng-repeat="product in pCtrl.mvProducts">                    	
                        <div class="thumbnail">
                            ...
                            <hr/>
                            <div class="caption">
                                <h4 class="text-center">&#8377; {{product.unitPrice}}</h4>
                    ...
                    <div class="col-sm-4 col-lg-4 col-md-4">
                        <br><br/><h4>Checkout more products!</h4>
                        <hr/>
